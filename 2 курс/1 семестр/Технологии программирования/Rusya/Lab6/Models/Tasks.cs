...
namespace Lab6.Models
{
    public class Tasks
    {
        ...
        public Tasks(string title, string description, DateOnly deadline, TaskStatuses status, string assignedTo, AdvertisingCampaign campaign)
        {
            this.title = title;
        ...
        public Tasks(long id, string title, string description, DateOnly deadline, TaskStatuses status, string assignedTo, AdvertisingCampaign campaign)
        {
            this.id = id;
            this.title = title;
            this.description = description;
