...
namespace Lab6.Models
{
    public class Projects
    {
        ...
        public Projects(string name, string description, DateOnly startDate,
            DateOnly endDate, decimal budget, ProjectStatuses status, Client client)
        {
            this.name = name;
        ...
        public Projects(long id, string name, string description, DateOnly startDate,
            DateOnly endDate, decimal budget, ProjectStatuses status)
        {
            this.id = id;
            this.name = name;
            this.description = description;
